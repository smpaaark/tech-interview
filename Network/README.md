...
* [TCP(Transmission Control Protocol)에 대해 설명해보세요.](#tcptransmission-control-protocol에-대해-설명해보세요)
* [UDP(User Datagram Protocol)에 대해 설명해보세요.](#udpuser-datagram-protocol에-대해-설명해보세요)
* [TCP는 어떻게 작동합니까?](#tcp는-어떻게-작동합니까)
* [common TCP/IP 프로토콜을 나열해보세요.](#tcpip-프로토콜을-나열해보세요)
* [TCP/IP와 OSI 모델을 비교해보세요.](#tcpip와-osi-모델을-비교해보세요)
* [UDP가 TCP보다 좋습니까?](#udp가-tcp보다-좋습니까)
* [Telnet 과 DNS의 포트 번호는 무엇입니까?](#telnet-과-dns의-포트-번호는-무엇입니까)
