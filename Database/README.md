...
* [select문 문법](#select문-문법)
* [Truncate와 Delete의 차이점은 무엇입니까?](#truncate와-delete의-차이점은-무엇입니까)
* [Having과 Where의 차이점은 무엇입니까?](#having과-where의-차이점은-무엇입니까)
* [테이블에서 중복된 레코드를 삭제하는 방법은 무엇입니까?](#테이블에서-중복된-레코드를-삭제하는-방법은-무엇입니까)
* [UNION과 UNION ALL의 차이점은 무엇입니까?](#union과-union-all의-차이점은-무엇입니까)
* [primary key, foreign key, unique key란 무엇입니까?](#primary-key-foreign-key-unique-key란-무엇입니까)
* [참고](#참고)
